...
//        System.out.println(posts);
        ...
        Comment comment6 = new Comment(3,13,"aut inventore non pariatur sit vitae voluptatem sapiente","Kariane@jadyn.tv","uga eos qui dolor rerum\\ninventore corporis exercitationem\\ncorporis cupiditate et deserunt recusandae est sed quis culpa\\neum maiores corporis et");
        ...
        comments.add(comment5);comments.add(comment6);comments.add(comment7);comments.add(comment8);
        ...
        for (int j = 0; j < posts.size(); j++) {
            ...
            for (int i = 0; i < comments.size(); i++) {
                ...
                if (comments.get(i).postId == posts.get(j).id) {

                    posts.get(j).comments.add(comments.get(i));
                }
            }
        }
        System.out.println(posts);
